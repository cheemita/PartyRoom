...
// Create the "room3" table if it doesn't exist
$sql_create_table = "CREATE TABLE IF NOT EXISTS family (
...
if ($mysql->query($sql_create_table) === TRUE) {
    echo "Table 'family' created successfully.<br>";
} else {
...
$sql_insert_data = "INSERT INTO family (idUser, numMesas, numInvitados, tipoFiesta, tipoComida)
        VALUES (?, ?, ?, ?, ?)";
